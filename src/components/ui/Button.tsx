...
const buttonVariants = cva(
  " flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:hover:bg-indigo-400 hover:bg-indigo-400 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        // ** FILLED
        ...
        danger:
          "bg-red-500 dark:bg-red-500 dark:text-white dark:hover:bg-red-700",
        cancel:
